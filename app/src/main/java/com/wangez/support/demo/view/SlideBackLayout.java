package com.wangez.support.demo.view;
...
/**
 * 当activity布局中嵌入当前布局，该activity可以从边缘滑动关闭
 * 实现原理：
 * 获取DecorView的RootView，删除RootView，把RootView添加到当前View，再把当前View添加到DecorView
 *
 * @author wangenzhao
 * @time 2017/3/12 下午7:14
 */
